...
import { onGotoStep, onBackStep, onNextStep, applyShipping } from 'redux/slices/product/product';
import { setAlert } from 'redux/slices/alert/alert';
...
export default function CheckoutPayment() {
  ...
  useEffect(() => {
    ...
    if (firstError) {
      setFocus(firstError, true);
      dispatch(
        setAlert({
          id: uuidv4(),
          type: 'error',
          message: `Select payment option${!isDesktop ? ' above.' : ' .'}`,
          timeout: 3000,
        })
      );
    }
