...
export default function NewPasswordForm({ email, setEmail }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (data.email && code && data.password) {
        const response = await resetPassword(data.email, code, data.password);
